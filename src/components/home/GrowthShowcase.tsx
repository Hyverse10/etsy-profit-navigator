            ...
            <div className="h-64 relative">
              ...
              <div className="absolute inset-0 flex items-end justify-between">
                {dailySales.map((data, index) => (
                  <div key={index} className="flex flex-col items-center group" style={{ height: '100%' }}>
                    <div 
                      className="w-10 bg-primary/20 rounded-t-sm group-hover:bg-primary/40 transition-colors"
                      style={{ 
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  ...
                  <span className="text-slate-500 font-medium">3 sales</span>
                </div>
                <div className="flex justify-between items-center p-3 border rounded-lg">
                  <span className="font-medium">Day 10</span>
                  <span>Momentum building</span>
                  <span className="text-slate-500 font-medium">12 sales</span>
                </div>
                <div className="flex justify-between items-center p-3 border rounded-lg bg-slate-50">
                  ...
                  <span className="text-primary font-medium">68 sales, $1,056 profit</span>
                </div>
              </div>
            </div>
